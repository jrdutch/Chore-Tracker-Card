...
export const TRANSLATIONS = {
  ...
  es: {
    ...
    adjustment: 'Ajuste',
    streak_field: 'Racha (d\u00edas)',
    streak_adjusted: 'Racha ajustada a {to} (antes {from})',
    streak_hint: 'Ajusta la racha si se perdi\u00f3 un d\u00eda porque no se aprobaron las tareas a tiempo. Acredita los d\u00edas omitidos pero no paga el bono; a\u00f1ade esos puntos arriba si correspond\u00eda.',
  ...
  de: {
    ...
    streak_hint: 'Setze die Serie, wenn ein Tag fehlt, weil Aufgaben nicht rechtzeitig freigegeben wurden. Die \u00fcbersprungenen Tage werden gutgeschrieben, der Bonus aber nicht ausgezahlt \u2014 f\u00fcge die Punkte oben hinzu, falls er zustand.',
    adjust_hint: 'Werte oben bearbeiten, um ein Guthaben zu korrigieren \u2014 die \u00c4nderung wird in den letzten Aktivit\u00e4ten des Mitglieds protokolliert.',
  ...
  fr: {
    ...
    streak_field: 'S\u00e9rie (jours)',
    streak_adjusted: 'S\u00e9rie r\u00e9gl\u00e9e sur {to} (avant {from})',
    streak_hint: 'R\u00e9glez la s\u00e9rie si un jour a \u00e9t\u00e9 manqu\u00e9 faute d\u2019approbation \u00e0 temps. Les jours saut\u00e9s sont cr\u00e9dit\u00e9s mais le bonus n\u2019est pas vers\u00e9 \u2014 ajoutez ces points ci-dessus s\u2019il \u00e9tait d\u00fb.',
    adjust_hint: 'Modifiez les valeurs ci-dessus pour corriger un solde \u2014 le changement est enregistr\u00e9 dans l\u2019activit\u00e9 r\u00e9cente du membre.',
